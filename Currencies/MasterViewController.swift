...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let currency = self.fetchedResultsController.object(at: indexPath)
        self.configureCell(cell, withCurrency: currency)
        return cell
    }
    ...
    func configureCell(_ cell: UITableViewCell, withCurrency currency: Currency) {
        cell.textLabel!.text = currency.title
        cell.detailTextLabel?.text = currency.code
        cell.detailTextLabel?.textColor = UIColor.gray
        let label = UILabel()
        label.text = currency.rate.description
        label.sizeToFit()
    ...
    var _fetchedResultsController: NSFetchedResultsController<Currency>? = nil
    ...
    func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>, didChange anObject: Any, at indexPath: IndexPath?, for type: NSFetchedResultsChangeType, newIndexPath: IndexPath?) {
        switch type {
            ...
            case .update:
                self.configureCell(tableView.cellForRow(at: indexPath!)!, withCurrency: anObject as! Currency)
            case .move:
